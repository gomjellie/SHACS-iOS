...
//primary color
const primaryColor = '#81E1B8'; // '#81E1B8' Mint '#fdbddb' pink
//secondary color
const secondaryColor = '#777';
//default color
const defaultColor = '#F8F8F8';
//default text color
const defaultTextColor = '#322425';
...
export default {
    ...
    rowAccessoryCheckColor: '#00FFFF',
    rowAccessoryIndicatorColor: '#bebebe',
    rowSeparatorColor: '#E9EDF0',
    ...
    poppAccessoryCheckColor: '#00FFFF',
